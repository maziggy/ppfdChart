...
class PPFDCustomCard extends LitElement {
    ...
    constructor() {
        ...
        this.fontColor = theme.fontColor || "#ffffff";
        this.bgColor = theme.bgColor || "#2c2c2e";
        this.innerBgColor = theme.innerBgColor || "#ccc";
        this.dliFontColor = theme.dliFontColor || "#4CAF50";
        this.sectionNameColor = theme.sectionNameColor || "#ffffff";
        this.separatorColor = theme.separatorColor || "#333";
        this.markerColor = theme.markerColor || "#222";
        this.tickColor = theme.tickColor || "#ffffff";
        this.tickLabelColor = theme.tickLabelColor || "#ccc"
    }
    ...
    static styles = css`
        ...
        .scale-tick {
            ...
            width: 1px;
            height: 10px;
            background-color: ${this.tickColor};
            top: -10px;
            left: 50%;
            transform: translateX(-50%);
        }
